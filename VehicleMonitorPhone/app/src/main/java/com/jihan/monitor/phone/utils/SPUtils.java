package com.jihan.monitor.phone.utils;
...
public class SPUtils {
    ...
    public static <E>void put(@NonNull String key, @NonNull E value) {
        put(PhoneApplication.appContext,key,value);
    }

    public static <E>E get(@NonNull String key,@NonNull E defaultValue) {
        return get(PhoneApplication.appContext,key,defaultValue);
    }
    ...
    public static boolean contains(String key) {
        return contains(PhoneApplication.appContext,key);
    }
